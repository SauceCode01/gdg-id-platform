...
export default function Button({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex items-center justify-center rounded-[8px] px-4 py-2.5 text-white transition duration-300 ease-out select-none overflow-hidden text-sm cursor-pointer",
        className
      )}
      style={{
    ...
    >
      ...
      <AnimatedGradientText className="  text-neutral-50  text-base leading-normal flex flex-row items-center justify-center translate-y-[-1.5px]">
        {children}
